...
export const LOCAL_SUPPLIER_CONFIG: Record<string, LocalSupplierConfig> = {
  ...
  cherouche:        { supplierName: 'Chèrouche',               supplierType: 'local', category: 'Vins',                    deadlineGroup: 'jeudi'    },
  olivier_stephanie:{ supplierName: 'Olivier et Stéphanie',    supplierType: 'local', category: 'Vins',                    deadlineGroup: 'jeudi'    },
  ...
  gregory_sermier:  { supplierName: "Alpage de Tsalan - Grégory Sermier - Arbaz - Fromages d'Alpage au lait de vache", supplierType: 'local', category: 'Fromages', deadlineGroup: 'jeudi' },
...
export const HEBDO_SHEET_CONFIG: Record<string, LocalSupplierConfig> = {
  ...
  'Chèrouche':          LOCAL_SUPPLIER_CONFIG.cherouche,
  'Olivier et Stéphanie': LOCAL_SUPPLIER_CONFIG.olivier_stephanie,
  /** Ancien onglet hebdo regroupé — conservé pour compatibilité fichiers Joel. */
  'Vins bio et nature': LOCAL_SUPPLIER_CONFIG.olivier_stephanie,
  ...
  "Alpage de Tsalan - Grégory Sermier - Arbaz - Fromages d'Alpage au lait de vache": LOCAL_SUPPLIER_CONFIG.gregory_sermier,
