...
const SUPPLIER_GROUPS: SupplierGroup[] = [
  {
    ...
    suppliers: [
      ...
      },
      {
        ...
        type: 'local',
        endpoint: '/api/admin/import-local-supplier',
        fileHint: 'Chèrouche (.xlsx ou .csv)',
        acceptsXlsx: true,
        acceptsCsv: true,
        deadlineGroup: 'jeudi',
      ...
      },
      {
        ...
        label: 'Olivier et Stéphanie',
        type: 'local',
        endpoint: '/api/admin/import-local-supplier',
        fileHint: 'Olivier et Stéphanie (.xlsx ou .csv)',
        acceptsXlsx: true,
        acceptsCsv: true,
        deadlineGroup: 'jeudi',
      ...
      {
        key: 'prefecture',
        label: 'Domaine de la Préfecture',
        type: 'local',
        endpoint: '/api/admin/import-local-supplier',
        fileHint: 'Préfecture (.xlsx ou .csv)',
        acceptsXlsx: true,
        acceptsCsv: true,
        deadlineGroup: 'jeudi',
      ...
      {
        key: 'evoleina',
        label: 'Evoleina Rhodiola',
        type: 'local',
        endpoint: '/api/admin/import-local-supplier',
        fileHint: 'Evoleina (.xlsx ou .csv)',
        acceptsXlsx: true,
        acceptsCsv: true,
        deadlineGroup: 'jeudi',
      ...
      },
      {
        ...
        type: 'local',
        endpoint: '/api/admin/import-local-supplier',
        fileHint: 'Les Devins (.xlsx ou .csv)',
        acceptsXlsx: true,
        acceptsCsv: true,
        deadlineGroup: 'jeudi',
      ...
      },
      {
        ...
        type: 'local',
        endpoint: '/api/admin/import-local-supplier',
        fileHint: 'Le Sapalet (.xlsx ou .csv)',
        acceptsXlsx: true,
        acceptsCsv: true,
        deadlineGroup: 'jeudi',
        fileInstructions: <>Fromagerie bio, Rossinière. Gabarit Produit / Prix / Unité ou nom;prix.</>,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    suppliers: [
      ...
      },
      {
        ...
        acceptsXlsx: true,
        acceptsCsv: true,
        fileHint: 'Phag (.xlsx ou .csv)',
        fileInstructions: <>Grossiste bio et diététique, Walchwil. Gabarit simple nom + prix (catalogue potentiellement volumineux).</>,
      },
    ],
  },
]
